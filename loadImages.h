...
void loadimages() {
	...
	//加载暗色背景图片
	loadimage(&bg_dark[0], "src/ColorImages/bg/bg1_dark.jpg"); //加载暗色背景图片1
	loadimage(&bg_dark[1], "src/ColorImages/bg/bg2_dark.jpg"); //加载暗色背景图片2
	loadimage(&bg_dark[2], "src/ColorImages/bg/bg3_dark.jpg"); //加载暗色背景图片3
	loadimage(&bg_dark[3], "src/ColorImages/bg/bg4_dark.jpg"); //加载暗色背景图片4
	loadimage(&bg_dark[4], "src/ColorImages/bg/bg5_dark.jpg"); //加载暗色背景图片5
